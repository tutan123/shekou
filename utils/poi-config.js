...
export const CATEGORIES = {
  ...
  binhai: {
    ...
    items: {
      ...
      '袁庚铜像': {
        top: 500, left: 300, width: 230,
        lng: 113.915, lat: 22.481,
        frame: ATLAS_BASE + 'binhai/14_yuangeng_frame.png',
        icon: ATLAS_BASE + 'binhai/14_yuangeng_pic.png',
  ...
  western: {
    ...
    items: {
      ...
      'the_flames': {
        ...
        lng: 113.917, lat: 22.491,
        frame: ATLAS_BASE + 'history/the_flames_frame.png', // 修正路径
